  ...
  return (
    <GuideShell>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Link
          href="/admin/character-icons"
          className="group rounded-lg border border-card-border bg-card p-6 shadow-card transition hover:border-primary/40 hover:shadow-md"
        >
          <div className="flex items-start justify-between">
            <div className="grid h-11 w-11 place-items-center rounded-md bg-violet-500/10 text-violet-600">
              <ImagePlus size={21} />
            </div>
            <ArrowRight size={18} className="text-muted-foreground transition group-hover:translate-x-1 group-hover:text-primary" />
          </div>
          <h2 className="mt-5 text-lg font-black">キャラクターアイコン管理</h2>
          <p className="mt-2 text-xs leading-5 text-muted-foreground">
            キャラクター詳細の左上に重ねる合成アイコン画像を登録・編集・削除します。
          </p>
        </Link>
